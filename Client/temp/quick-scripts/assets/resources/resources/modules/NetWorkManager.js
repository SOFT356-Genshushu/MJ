(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/resources/resources/modules/NetWorkManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cfadcqDGlJNnYLduNhOAkkr', 'NetWorkManager', __filename);
...
var NetWorkManager = function () {
    ...
    _createClass(NetWorkManager, null, [{
        ...
        value: function clearHallService() {
            //Clean up the connection of the current Hall
        ...
        value: function connectAndAuthToGame(account, pass, url) {
            ...
            NetWorkManager.g_GameService.onReady(function (service) {
                service.proxy.login(account, pass, function (data) {
                    if (data.ok && data.suc) {
                        cc.log('Log in to the game server successfully:');
                        cc.log(data);
