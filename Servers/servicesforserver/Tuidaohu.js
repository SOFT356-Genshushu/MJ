...
module.exports = function () {
    ...
    service.createTable = function (playerId,tableId,roomInfo,serverCode,cb) {
        ...
        if(oldTableId){
            cb({ok:true,suc:false,tableId:oldTableId,info:"The player is already in the game"});
            return;
        }
    ...
    service.hitCard = function (data,cb) {
        //Judge the legitimacy of licensing
    ...
    service.isPlayerInGame = function (playerId,code,cb) {
        //code 1 Indicates playing, 2 indicates not playing
        if(safeCode!=code){
            cb({ok:true,suc:false});
            return;
        }
